            ...
            switch (aCommand) {
                ...
                case FUNCTION_DRAW_VECTOR_DEGREE:
                    ...
                    if (aCommand == FUNCTION_DRAW_LINE_REL) {
                        ...
                        tXEndScaled = (float) (tXStartScaled + ((Math.cos(tRadianOfDegree) * tLength) + 0.5) * mScaleFactor);
                        tYEndScaled = (float) (tYStartScaled - ((Math.sin(tRadianOfDegree) * tLength) + 0.5) * mScaleFactor);
                    } else {
                ...
                case FUNCTION_DRAW_VECTOR_RADIAN:
                    ...
                    tXEndScaled = (float) (tXStartScaled + ((Math.cos(tRadian) * tLength) + 0.5) * mScaleFactor);
                    tYEndScaled = (float) (tYStartScaled - ((Math.sin(tRadian) * tLength) + 0.5) * mScaleFactor);

...
public class TouchButton {
    ...
    void setPosition(int aPositionX, int aPositionY) {
        ...
        if (aPositionX > mRPCView.mRequestedCanvasWidth) {
            MyLog.e(LOG_TAG, mEscapedText + " Button x-position " + aPositionX + " is too big. Set width to 0");
            aPositionX = 0;
        }
        if (aPositionX + mWidth > mRPCView.mRequestedCanvasWidth) {
            MyLog.e(LOG_TAG, mEscapedText + " Button x-position + width " + aPositionX + " + " + mWidth + " is too big. Set width to:"
        ...
        if (aPositionY > mRPCView.mRequestedCanvasHeight) {
            MyLog.e(LOG_TAG, mEscapedText + " Button y-position " + aPositionY + " is too big. Set position to 0");
            aPositionY = 0;
        }
        if (aPositionY + mHeight > mRPCView.mRequestedCanvasHeight) {
            MyLog.e(LOG_TAG, mEscapedText + " Button y-position + height " + aPositionY + " + " + mHeight + " is too big. Set height to:"

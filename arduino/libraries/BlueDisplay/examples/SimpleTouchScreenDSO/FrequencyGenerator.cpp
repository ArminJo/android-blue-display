...
void createFrequencyGui(void) {
    ...
    TouchSliderFrequency = BlueDisplay1.createSlider(FREQ_SLIDER_X, FREQ_SLIDER_Y, FREQ_SLIDER_SIZE, FREQ_SLIDER_MAX_VALUE,
            FREQ_SLIDER_MAX_VALUE, 0, COLOR_BLUE, COLOR_GREEN, TOUCHSLIDER_SHOW_BORDER | TOUCHSLIDER_IS_HORIZONTAL,
            &doFrequencySlider);
...
// Fixed frequency buttons next
    ...
    tXPos = 0;
    TouchButtonmHz = BlueDisplay1.createButtonPGM(tXPos,
            DISPLAY_HEIGHT - BUTTON_HEIGHT_4 - BUTTON_HEIGHT_5 - BUTTON_DEFAULT_SPACING,
            BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING_HALF, BUTTON_HEIGHT_5, COLOR_GREEN, PSTR("mHz"), TEXT_SIZE_22,
            BUTTON_FLAG_DO_BEEP_ON_TOUCH, 0, &doChangeFrequencyFactor);
    tXPos += BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING;
    TouchButtonHz = BlueDisplay1.createButtonPGM(tXPos, DISPLAY_HEIGHT - BUTTON_HEIGHT_4 - BUTTON_HEIGHT_5 - BUTTON_DEFAULT_SPACING,
            BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING_HALF, BUTTON_HEIGHT_5, COLOR_GREEN, PSTR("Hz"), TEXT_SIZE_22,
            BUTTON_FLAG_DO_BEEP_ON_TOUCH, 1, &doChangeFrequencyFactor);
    tXPos += BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING;
    TouchButton10Hz = BlueDisplay1.createButtonPGM(tXPos,
            DISPLAY_HEIGHT - BUTTON_HEIGHT_4 - BUTTON_HEIGHT_5 - BUTTON_DEFAULT_SPACING,
            BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING_HALF, BUTTON_HEIGHT_5, COLOR_GREEN, PSTR("10Hz"), TEXT_SIZE_22,
            BUTTON_FLAG_DO_BEEP_ON_TOUCH, 42, &doChangeFrequencyFactor);
    tXPos += BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING;
    TouchButtonkHz = BlueDisplay1.createButtonPGM(tXPos,
            DISPLAY_HEIGHT - BUTTON_HEIGHT_4 - BUTTON_HEIGHT_5 - BUTTON_DEFAULT_SPACING,
            BUTTON_WIDTH_5 + BUTTON_DEFAULT_SPACING_HALF, BUTTON_HEIGHT_5, COLOR_GREEN, PSTR("kHz"), TEXT_SIZE_22,
    ...
    TouchButtonMHz = BlueDisplay1.createButtonPGM(tXPos,
            ...
            COLOR_GREEN, PSTR("MHz"), TEXT_SIZE_22, BUTTON_FLAG_DO_BEEP_ON_TOUCH, 3, &doChangeFrequencyFactor);
...
void drawFrequencyGui(void) {
    ...
    BlueDisplay1.drawButton(TouchButtonmHz);
    BlueDisplay1.drawButton(TouchButtonHz);
    BlueDisplay1.drawButton(TouchButton10Hz);
    BlueDisplay1.drawButton(TouchButtonkHz);
    BlueDisplay1.drawButton(TouchButtonMHz);
...
void doFreqGenStartStop(uint8_t aTheTouchedButton, int16_t aValue) {
    ...
    BlueDisplay1.setRedGreenButtonColorAndDraw(TouchButtonFrequencyStartStop, aValue);
}
...
void initTimer(void) {
    ...
    TCCR1A = (1 << COM1A0); // Toggle OC1A on compare match / CTC mode
    TCCR1B = (1 << WGM12); // CTC with OCR1A - Timer disabled
}

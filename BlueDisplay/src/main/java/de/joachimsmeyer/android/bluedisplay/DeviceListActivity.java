...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button tConnectButton = findViewById(R.id.connect_last_device);
        /*
        ...
        if (tDeviceNameLastConnected.equalsIgnoreCase("null")) {
            ...
            String tNewCaption;
            if (tIndex >= 0) {
                tOldCaption = (String) tOldCaption.subSequence(0, tIndex);
            }
        ...
        tConnectButton.setOnClickListener(v -> {
        ...
        // with this code I always have no permission, without this code I am asked at the first run time for the permission.
        // Tested on 6.0 and
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//            if (checkSelfPermission(Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
//                requestPermissions(new String[]{Manifest.permission.BLUETOOTH_CONNECT}, 1);
//                MyLog.e(LOG_TAG, "Cannot build Bluetooth device list, because no BLUETOOTH_CONNECT granted by user");
//                return;
//            }
//        }
        ...
        if (mPairedDevices.size() == 1
             ...
             */
            List<String> tDeviceNameList = new ArrayList<>(mPairedDevices.size());
...
//                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//                        if (checkSelfPermission(Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
//                            MyLog.e(LOG_TAG, "Cannot get Bluetooth name, because no BLUETOOTH_CONNECT granted by user");
//                            return;
//                        }
//                    }

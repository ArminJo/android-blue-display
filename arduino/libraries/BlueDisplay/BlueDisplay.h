...
// If used as background color for multiline text, then do not clear rest of line
#define COLOR_NO_BACKGROUND_EXTEND   ((Color_t)0XFFFD)
...
// codes start with 0 - 15 for DTMF tones and ends with code TONE_CDMA_SIGNAL_OFF=98 for silent tone
...
#define TONE_LAST_VALID_TONE_INDEX 99
